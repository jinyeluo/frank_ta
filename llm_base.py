...
"""
    ...
    async def analyze_single_stock(self, csv_file) -> Optional[AnalyzedResult]:
        ...
        formatted_data = self.build_user_request(symbol, latest_data, recent_data, full_data)
    ...
    def save_recommendation(self, ticket: str, html_result: AnalyzedResult):
        output_file = os.path.join(self.data_dir, f"{ticket}_{self.vendor}_recommendations.html")
